...
export const GameEnvironmentVariables = {
  ...
  constructor(scope: Construct, id: string, props: GameStackProps) {
    ...
    const api = new SingleHandlerApi(this, this.generateId("api"), {
      ...
      additionalEnvironmentVariables: {
        ...
        [GameEnvironmentVariables.EVENT_BUS_ARN]: eventBusArn,
      },
      layers: {},
      userPoolArn,
    ...
    const eventHandler = new LambdaFunction(this, this.generateId("event-handler"), {
      ...
      environment: {
        [GameEnvironmentVariables.EVENT_BUS_ARN]: eventBusArn,
        [GameEnvironmentVariables.DATA_TABLE_NAME]: `${props.env.prefix}-${props.dataTableName}`,
      },
    });
