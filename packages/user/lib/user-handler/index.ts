...
import { InvitationState, ParticipationState, PlayerGameDTO, PlayerGameItem, playerGameMapper } from "../player-game-dto";
...
export async function handler(event: APIGatewayProxyEvent) {
  ...
  } else if (resourcePath === '/player-game/{gameId}/{participantAction}' && httpMethod === 'PATCH') {
